...
<html>
    ...
    try
    {
             ...
             c1=DriverManager.getConnection("jdbc:mysql://localhost/company?useSSL=false","root","root");
           
             st = c1.createStatement();
             q="select c_name,establish,email,contact,hr_name from company";
             ...
             while(rs1.next())
             {
                 ...
                 out.println("<tr><td>"+"-"+"</td><td>"+cname+"</td><td>"+establish+"</td><td>"+email+"</td><td>"+contact+"</td><td>"+hr_name+"</td></tr>");
                 out.println("</div>");
             }   
              }
             catch(Exception e)
