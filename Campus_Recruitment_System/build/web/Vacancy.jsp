               ...
               <div class="col-lg-9">
                    <div class="col-lg-5 offset-3">             
                       ...
                       <div class="form-group">
                        ...
                        <input class="form-control" type="String" name="c_id" placeholder="Enter Company Id" />
                    </div>
                       
                       <div class="form-group">
                        <label for="inputName">Job Profile</label>
                        <select class="form-control" type="text" name="job" placeholder="Enter Company Name" >
                            <option>Data Eng.</option>
                            <option>Cloud Eng.</option>
                         </select>
                    </div>
